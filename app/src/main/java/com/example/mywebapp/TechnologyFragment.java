...
public class TechnologyFragment extends Fragment {
    ...
    private String urlnews = "https://newsapp-backend-99.appspot.com/technology/0";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.technology_fragment, container, false);
        myrecyclerview = (RecyclerView) v.findViewById(R.id.technology_recyclerview);
        //RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(getContext(), listcards);
        //myrecyclerview.setLayoutManager(new LinearLayoutManager(getActivity()));
        //myrecyclerview.setAdapter(recyclerViewAdapter);

        ProgressBar spinner = (ProgressBar) v.findViewById(R.id.progress_bar_technology);
        myrecyclerview.setVisibility(View.INVISIBLE);
        spinner.setVisibility(View.VISIBLE);
        v.findViewById(R.id.progress_text_technology).setVisibility(View.VISIBLE);
        getData();

        mSwipeRefreshLayout = v.findViewById(R.id.swiperefresh_technology);
    ...
    public void getData()
    {
        ...
        JsonObjectRequest jsonObjectRequestNews = new JsonObjectRequest(Request.Method.GET, urlnews, null, new Response.Listener<JSONObject>()  {
            ...
            public void onResponse(JSONObject response) {
                //Log.d("Technology", response.toString());
                try {
                    ...
                    Log.d("Technology", listcards.toString());
                    ...
                    v.findViewById(R.id.progress_text_technology).setVisibility(View.INVISIBLE);
            ...
            public void onErrorResponse(VolleyError error) {
                // TODO: Handle error
                Log.d("Error", "Error in Technology Fragment : News");
            }
        });
