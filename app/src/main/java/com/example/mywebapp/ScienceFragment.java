...
public class ScienceFragment extends Fragment {
    ...
    private String urlnews = "https://newsapp-backend-99.appspot.com/science/0";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.science_fragment, container, false);
        myrecyclerview = (RecyclerView) v.findViewById(R.id.science_recyclerview);
        //RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(getContext(), listcards);
        //myrecyclerview.setLayoutManager(new LinearLayoutManager(getActivity()));
        //myrecyclerview.setAdapter(recyclerViewAdapter);

        ProgressBar spinner = (ProgressBar) v.findViewById(R.id.progress_bar_science);
        spinner.setVisibility(View.VISIBLE);
        myrecyclerview.setVisibility(View.INVISIBLE);
        v.findViewById(R.id.progress_text_science).setVisibility(View.VISIBLE);
        getData();

        mSwipeRefreshLayout = v.findViewById(R.id.swiperefresh_science);
    ...
    public void getData()
    {
        ...
        JsonObjectRequest jsonObjectRequestNews = new JsonObjectRequest(Request.Method.GET, urlnews, null, new Response.Listener<JSONObject>()  {
            ...
            public void onResponse(JSONObject response) {
                //Log.d("Science", response.toString());
                try {
                    ...
                    Log.d("Science", listcards.toString());
                    ...
                    v.findViewById(R.id.progress_text_science).setVisibility(View.INVISIBLE);
            ...
            public void onErrorResponse(VolleyError error) {
                // TODO: Handle error
                Log.d("Error", "Error in Science Fragment : News");
            }
        });
