...
public class SportsFragment extends Fragment {
    ...
    private String urlnews = "https://newsapp-backend-99.appspot.com/sports/0";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ProgressBar spinner = (ProgressBar) v.findViewById(R.id.progress_bar_sports);
        spinner.setVisibility(View.VISIBLE);
        myrecyclerview.setVisibility(View.INVISIBLE);
        v.findViewById(R.id.progress_text_sports).setVisibility(View.VISIBLE);
        getData();

        mSwipeRefreshLayout = v.findViewById(R.id.swiperefresh_sports);
    ...
    public void getData()
    {
        ...
        JsonObjectRequest jsonObjectRequestNews = new JsonObjectRequest(Request.Method.GET, urlnews, null, new Response.Listener<JSONObject>()  {
            ...
            public void onResponse(JSONObject response) {
                //Log.d("Sports", response.toString());
                try {
                    ...
                    Log.d("Sports", listcards.toString());
                    ...
                    v.findViewById(R.id.progress_text_sports).setVisibility(View.INVISIBLE);
            ...
            public void onErrorResponse(VolleyError error) {
                // TODO: Handle error
                Log.d("Error", "Error in Sports Fragment : News");
            }
        });
