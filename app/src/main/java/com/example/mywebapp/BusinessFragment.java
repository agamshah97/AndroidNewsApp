...
public class BusinessFragment extends Fragment {
    ...
    private String urlnews = "https://newsapp-backend-99.appspot.com/business/0";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.business_fragment, container, false);
        myrecyclerview = (RecyclerView) v.findViewById(R.id.business_recyclerview);
        //RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(getContext(), listcards);
        //myrecyclerview.setLayoutManager(new LinearLayoutManager(getActivity()));
        //myrecyclerview.setAdapter(recyclerViewAdapter);

        ProgressBar spinner = (ProgressBar) v.findViewById(R.id.progress_bar_business);
        myrecyclerview.setVisibility(View.INVISIBLE);
        spinner.setVisibility(View.VISIBLE);
        v.findViewById(R.id.progress_text_business).setVisibility(View.VISIBLE);
        getData();

        mSwipeRefreshLayout = v.findViewById(R.id.swiperefresh_business);
    ...
    public void getData()
    {
        ...
        JsonObjectRequest jsonObjectRequestNews = new JsonObjectRequest(Request.Method.GET, urlnews, null, new Response.Listener<JSONObject>()  {
            ...
            public void onResponse(JSONObject response) {
                //Log.d("Business", response.toString());
                try {
                    ...
                    Log.d("Business", listcards.toString());
                    ...
                    v.findViewById(R.id.progress_text_business).setVisibility(View.INVISIBLE);
            ...
            public void onErrorResponse(VolleyError error) {
                // TODO: Handle error
                Log.d("Error", "Error in Business Fragment : News");
            }
        });
